...
final class ServiceMethod<R, T> {
    ...
    /**
     * Inspects the annotations on an interface method to construct a reusable service method. This requires
     * potentially-expensive reflection so it is best to build each service method only once and reuse it. Builders
     * cannot be reused.
     */
    static final class Builder<T, R> {
        ...
        private ParameterHandler<?> parseParameterAnnotation(
            ...
            if (annotation instanceof Url) {
                ...
                gotQuery = true;
                if (Iterable.class.isAssignableFrom(rawParameterType) && !query.rawProcessing()) {
                ...
                } else if (rawParameterType.isArray() && !query.rawProcessing()) {
        ...
        private RuntimeException methodError(@Nullable Throwable cause, String message, Object... args) {
